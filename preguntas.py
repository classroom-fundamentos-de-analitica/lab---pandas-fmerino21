...
def pregunta_03():
    ...
    """
    return tbl0.value_counts('_c1').sort_index()
...
def pregunta_06():
    ...
    """
    aux = sorted(tbl1['_c4'].unique())
    ans = [i.upper() for i in aux]
    return ans
...
def pregunta_09():
    ...
    """
    tbl0_copy = tbl0.copy()
    tbl0_copy['year'] = tbl0_copy['_c3'].str[:4]
    return tbl0_copy
...
def pregunta_13():
    ...
    """
    return pd.merge(tbl0, tbl2).groupby('_c1').sum()['_c5b']
